...
g3
```
Based on the Boxplout Above, Women have higher scores than Men, Men have a much lower Median than Women and Much lower Average.

As we have seen the boxplots, we can see the distribution of scores for Men and Women and we can see Men have an edge in higher scores
```{r}
